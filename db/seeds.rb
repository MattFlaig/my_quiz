...
quiz = Quiz.create(quiz_name: "Very easy logical sequences", description: "Please find the next element in the sequences below", category_id: categories.first.id, user_id: user.id, question_ids: [questions.first.id, questions.last.id])